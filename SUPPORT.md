...
Provide the DSH snapshot and profile, plugin version, browser and OS versions, the share-flow step where the issue occurred, minimal reproduction steps, expected behavior, and sanitized output. Remove API keys, authorization headers, complete prompts or conversations, and unrelated workspace paths.
