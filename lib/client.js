window.__ModuleLoader__.load({
	id: "@dsh-external/dsh-conversation-share",
	factory: (require) => {
		var module = { exports: {} };
		...
		*/
		...
		function shareButtonStyle() {
			return [
				...
				"background:transparent;color:var(--dsw-alias-label-tertiary, " + themeColors().labelTertiary + ");",
		...
		function ghostButtonStyle() {
			...
			return [
				...
				"font:500 13px/16px -apple-system,BlinkMacSystemFont,'Segoe UI','PingFang SC','Hiragino Sans GB','Microsoft YaHei',sans-serif;cursor:pointer;flex:none;"
			].join("");
		}
		/** Primary 确认 button. */
