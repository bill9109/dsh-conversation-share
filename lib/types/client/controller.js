...
import { findFlowList, findScrollport, findTablist, switchToChatTab } from "./dom.js";
import { ghostButtonStyle, primaryButtonStyle, shareButtonStyle, shareIconSVG, } from "./icons.js";
...
export class ShareController {
    ...
    syncButton() {
        ...
        if (this.tablist === tablist && this.shareButton !== null && tablist.contains(this.shareButton))
            return;
